...
- `calendar_events_cache` senkronizasyonu (şemada var, hiç doldurulmuyor — mail-update tespiti bunun yerine `candidate_events.google_event_id`'yi kullanıyor, ayrı bir çözüm).
